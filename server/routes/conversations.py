...
from server.schemas import (
	ConversationSingleResponse, ConversationListResponse, OkResponse, TypingResponse,
)
...
@router.post("", response_model=ConversationSingleResponse)
...
@router.get("/{conv_id}", response_model=ConversationSingleResponse)
...
@router.post("/{conv_id}/members", response_model=OkResponse)
...
@router.delete("/{conv_id}/members/{agent_id}", response_model=OkResponse)
...
@router.post("/{conv_id}/read", response_model=OkResponse)
...
@router.post("/{conv_id}/typing", response_model=OkResponse)
...
@router.delete("/{conv_id}/typing", response_model=OkResponse)
...
@router.get("/{conv_id}/typing", response_model=TypingResponse)
